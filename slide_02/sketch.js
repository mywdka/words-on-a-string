...
// // to be changed individually upon mouse touch
...
function setup() {
    ...
    const subtitle = select('#subtitle').html(''); // selects text object and clears it
    ...
    span.mouseOver(function() {
        textHover(this); // trigger this function we just created
    });
